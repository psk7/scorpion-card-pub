...
#define __HIDPARSER_H__
    ...
    class HIDParser {
        public:
            ...
            uint8_t ParseDescriptor(const uint8_t* ReportData,
                                         uint16_t ReportSize,
                                         HID_ReportInfo_t* const ParserData);



            uint32_t GetItemInfo(const uint8_t* ReportData, HID_ReportItem const &ReportItem);
