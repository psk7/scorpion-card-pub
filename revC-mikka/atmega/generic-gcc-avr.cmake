...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   set_target_properties(
      ...
      PROPERTIES
         ...
         LINK_FLAGS "-mmcu=${AVR_MCU} -Wl,--gc-sections -mrelax -Wl,-Map,${map_file},--print-memory-usage ${EXTRA_FLAGS}"
   )
   ...
   add_custom_command(
           OUTPUT ${lss_file}
           COMMAND ${AVR_OBJDUMP} -h -S ${elf_file} > ${lss_file}
           DEPENDS ${elf_file}
   )
   ...
   add_custom_target(
      ${EXECUTABLE_NAME}
      ALL
      DEPENDS ${hex_file} ${eeprom_image} ${bin_file} ${lss_file}
   )
