...
public:
    ...
    void MapJoystickAndSend(KeysList &List);
    ...
    struct JoystickMappingInfo::ZxJoystickMapping GetZxJoystickMapping() const;

    struct JoystickMappingInfo::Mapping::Bindings GetJoystickMapping() const;
};
